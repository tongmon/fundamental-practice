...
그 뿐만 아니라 밑과 같이 그냥 atomic 변수를 사용한 모든 명령이 원자적이다.  
```c++
...
게다가 Mutex를 사용하는 것보다 속도도 빠르다!  
&nbsp;  

이렇게만 보면 atomic을 사용하기 쉬워보이지만... 껄끄러운 부분들이 몇몇 존재한다.   
...
하지만 퍼포먼스가 떨어져 개발자가 의도한 코드와 멀어질 수 있다.  
&nbsp;  
